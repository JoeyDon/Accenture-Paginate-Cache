// PAGE_SIZE: How many cards to display in each page
export const PAGE_SIZE = 12;

// MAX_CACHE_PAGES: How many pages to cache at one time
export const MAX_CACHE_PAGES = 8;

// INITIAL_CACHE_PAGES: How many pages to cache initially
export const INITIAL_CACHE_PAGES = 5;

// API_TOKEN: ***Malicious attempts*** will be held accountable.
...
// phoneViewportWidth: Display mobile CSS
export const PHONE_VIEWPORT_WIDTH = 415;
